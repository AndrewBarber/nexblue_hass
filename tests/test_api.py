...
@pytest.mark.asyncio
async def test_api_token_refresh_failure_fallback_to_login(hass, aioclient_mock, caplog):
...
async def test_api_get_data_charger_missing_serial(hass, aioclient_mock, caplog):
    ...
    result = await api.async_get_data()
    assert result == {"chargers": []}  # Returns empty chargers list when no valid chargers
...
async def test_api_wrapper_unsupported_method(hass, aioclient_mock, caplog):
    ...
    result = await api.api_wrapper("invalid_method", "https://api.nexblue.com/third_party/openapi/test")
...
async def test_api_wrapper_put_method(hass, aioclient_mock, caplog):
    ...
    # Mock PUT request
    aioclient_mock.put(
        "https://api.nexblue.com/third_party/openapi/test",
        json={"status": "success"}
    )
    
    result = await api.api_wrapper("put", "https://api.nexblue.com/third_party/openapi/test", {"data": "test"})
...
async def test_api_wrapper_patch_method(hass, aioclient_mock, caplog):
    ...
    result = await api.api_wrapper("patch", "https://api.nexblue.com/third_party/openapi/test", {"data": "test"})
    assert result == {"status": "success"}
...
async def test_api_wrapper_delete_method(hass, aioclient_mock, caplog):
    ...
    result = await api.api_wrapper("delete", "https://api.nexblue.com/third_party/openapi/test")
    assert result == {"status": "success"}
...
async def test_api_wrapper_timeout(hass, aioclient_mock, caplog):
    ...
    result = await api.api_wrapper("get", "https://api.nexblue.com/third_party/openapi/chargers")
    assert result is None
